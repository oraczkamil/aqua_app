...
export const loadOneDay = date => ({ type: constants.LOAD_ONE_DAY, payload: date });
...
export const deleteMeeting = id => ({ type: constants.DELETE_MEETING, payload: { id: id, date: date } });